...
import { JourneyCard } from './journey-card/journey-card.component';

@Component({
  selector: 'app-home',
  standalone: true,
  imports: [RouterLink, CommonModule, JourneyCard],
...
export class Home {
  ...
  softwareSkills = [
    { name: 'VHDL', img: 'images/VHDL.png' },
    { name: 'Vivado', img: 'images/vivado.png' },
    { name: 'ADS', img: 'images/ADS.jpg' },
    { name: 'OrCAD', img: 'images/Orcad.png' },
    { name: 'PSpice', img: 'images/Pspice.png' },
    { name: 'MPLAB', img: 'images/MPlab.png' },
    ...
    { name: 'HFSS', img: 'images/logo_HFSS.png' }
  ];
